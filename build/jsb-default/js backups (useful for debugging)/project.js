...
onLoad: function() {
window.callOCMethoed = function(e) {
console.log(e);
};
},
callOCMethoed: function(e) {
console.log(e);
alert("====" + e);
},
update: function(e) {},
...
alert(cc.sys.os);
jsb.reflection.callStaticMethod("NativeOcClass", "callNativeUIWithTitle:andContent:", "123木头人", "我们的故事，是很长的电影");
}
} else if ("sharetrace" === t) {
var c = jsb.reflection.callStaticMethod("SDKManager", "getSharetraceParam");
cc.log("====sharetrace结果:", c);
this.label1.string = c;
n.default.showTipsUI(c);
}
}
});
cc._RF.pop();
